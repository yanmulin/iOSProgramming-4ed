...
-(instancetype)initWithCoder:(NSCoder *)aDecoder {
    self = [super init];
    if (self) {
        _itemName = [aDecoder decodeObjectOfClass:NSString.class forKey:@"itemName"];
        ...
        _itemKey = [aDecoder decodeObjectOfClass:NSString.class forKey:@"itemKey"];
        _valueInDollars = [aDecoder decodeIntForKey:@"valueInDollars"];
        _thumbnail = [aDecoder decodeObjectOfClass:UIImage.class forKey:@"thumbnail"];
    }
    return self;
}
