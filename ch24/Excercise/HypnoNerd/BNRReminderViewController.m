...
+(UIViewController *)viewControllerWithRestorationIdentifierPath:(NSArray<NSString *> *)identifierComponents coder:(NSCoder *)coder {
    NSLog(@"reminder: %@", identifierComponents);
    return ((UITabBarController *)([UIApplication sharedApplication].delegate.window.rootViewController)).viewControllers[1];
}

-(void)encodeRestorableStateWithCoder:(NSCoder *)coder {
    [coder encodeObject:self.datePicker.date forKey:@"RemindDate"];
